...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="assets/intranet/img/apple-icon.png">
    <link rel="icon" type="image/png" href="assets/intranet/img/favicon.png">
    <title>
        Maekween - Iniciar Sesion
    </title>
    <!--     Fonts and icons     -->
                        ...
                        <div class="card-body">
                            ...
                            <form method="post">
                                ...
                                <p class="mt-4 text-sm text-center">
                                    ¡No tienes cuenta!
                                    <a href="./sign-up" class="text-primary text-gradient font-weight-bold">Registrate</a>
                                </p>
                            </form>
                        </div>
                    </div>
